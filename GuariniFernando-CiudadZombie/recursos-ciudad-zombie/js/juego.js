...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/auto_verde_abajo.png', 70, 230, 15, 30, 2),//PRIMER PEATONAL
    new Obstaculo('imagenes/bache.png', 150, 230, 30, 30, 1), //PRIMER PEATONAL
    new Obstaculo('imagenes/valla_horizontal.png', 70, 430, 30, 30, 1),//ESQUINA INFERIOR IZQUIERDA
    new Obstaculo('imagenes/valla_horizontal.png', 100, 430, 30, 30, 1),//ESQUINA INFERIOR IZQUIERDA
    new Obstaculo('imagenes/valla_horizontal.png', 130, 430, 30, 30, 1),//ESQUINA INFERIOR IZQUIERDA
    new Obstaculo('imagenes/valla_vertical.png', 150, 450, 30, 30, 1),//ESQUINA INFERIOR IZQUIERDA
    new Obstaculo('imagenes/valla_vertical.png', 150, 480, 30, 30, 1),//ESQUINA INFERIOR IZQUIERDA
    new Obstaculo('imagenes/valla_vertical.png', 460, 400, 30, 30, 1),//SEGUNDA PEATONAL
    new Obstaculo('imagenes/valla_vertical.png', 460, 420, 30, 30, 1),//SEGUNDA PEATONAL
    new Obstaculo('imagenes/bache.png', 250, 370, 30, 30, 1),//SEGUNDA PEATONAL
    new Obstaculo('imagenes/auto_verde_derecha.png', 380, 460, 30, 15, 2),//SEGUNDA PEATONAL
    new Obstaculo('imagenes/bache.png', 300, 480, 30, 30, 1),//SEGUNDA PEATONAL
    new Obstaculo('imagenes/bache.png', 500, 130, 30, 30, 1),//ULTIMA PEATONAL
    new Obstaculo('imagenes/bache.png', 500, 70, 30, 30, 1),//ULTIMA PEATONAL
    new Obstaculo('imagenes/auto_verde_abajo.png', 850, 400, 15, 30, 2), //RECTA FINAL
    new Obstaculo('imagenes/auto_verde_abajo.png', 755, 155, 15, 30, 2), //RECTA FINAL
    new Obstaculo('imagenes/bache.png', 800, 430, 30, 30, 1),//RECTA FINAL
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie4.png', 390, 155, 10, 10, 3, {
      desdeX: 0,  
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    ...
    new ZombieCaminante('imagenes/zombie2.png', 80, 400, 10, 10, 2, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie3.png', 480, 225, 10, 10, 2, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    ...
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 9, { 
      desdeX: 0,
      hastaX: 961,
      desdeY: -15,
      hastaY: 600
